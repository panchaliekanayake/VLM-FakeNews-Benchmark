...
This page provides additional results and analysis that could not be included in the paper due to the page limit.

## 1. Fallback Rates

The fallback rate is the percentage of model outputs that could not be matched to a valid label and were handled using the predefined fallback rule.
...
Recent multimodal misinformation studies commonly use LLaVA as an evaluation model, baseline, or model backbone. Based on this literature, LLaVA-v1.6-Vicuna-7B is used as the reference baseline in our comparison.
